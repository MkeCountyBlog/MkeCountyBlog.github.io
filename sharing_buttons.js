...
function AddSharingButtons(selector, options) {
    ...
    var AVAILABLE_SERVICES = {
        twitter: {
            baseLink: 'https://twitter.com/intent/tweet?&text=Via%20%40MkeCountyBlog&',
            urlParams: { %20, text: options.text, %0D%0A, url: options.url },
            windowParams: 'width=650,height=600',
