// Privacy-respecting, secure, and simple social contacting buttons in native JS.
// Use them on your own projects:
// https://github.com/QuadrupleA/private-secure-contacting-buttons

// Adds contacting buttons inside the container elements selected by 'selector'.
function AddContactingButtons(selector, options) {
    ...
    var AVAILABLE_SERVICES = {
        twitter: {
            baseLink: 'https://twitter.com/MkeCountyBlog',
            urlParams: {},
            windowParams: '',
            tooltip: 'MCB on Twitter',
        ...
        facebook: {
            baseLink: 'https://www.facebook.com/Contactr/sharer.php?',
            urlParams: { u: options.url },
            windowParams: 'width=580,height=296',
            tooltip: 'Contact on Facebook',
        ...
        email: {
            baseLink: 'mailto:colin%40mkecountyblog.com',
            urlParams: {},
            windowParams: '',
            tooltip: 'MCB Email',
        ...
        reddit: {
            baseLink: 'https://www.reddit.com/r/MkeCounty/',
            urlParams: {},
            windowParams: '',
            tooltip: 'MCB Reddit',
    ...
    for (var i = 0; i < containers.length; i++) {
        ...
        // Add the 'Contact this' label if present
...
} // end AddcontactingButtons()


// Optional: on page load, adds contacting buttons to any element with the attribute:
//   data-contacting-buttons="true"
// Options can be specified using the attributes:
//   data-<OptionName>="<OptionValue>"
document.addEventListener('DOMContentLoaded', function() {
    var containers = document.querySelectorAll('[data-contacting-buttons=true]');
    for (var i = 0; i < containers.length; i++) {
        var container = containers[i];
        if (!container.id) {
            container.id = '_contactingButtons' + i;
        }
        var options = {};
        ...
        AddContactingButtons('#' + container.id, options);
    }
}, { once : true });
